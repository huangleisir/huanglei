...
<%}else{%>
	&nbsp;欢迎光临管理员：<span style="font-weight:bold;"><%=currentName %></span>
...
<%}%>
	&nbsp;<a href="javascript:loginOut();" style="color:black;text-decoration:underline;">退出</a>
<%} %>
&nbsp;
</td></tr>
...
<div style="border: 1px solid #CCCCFF;">
		<c:forEach items="${news3}" var="item3" varStatus="i">
			<div <c:if test="${i.index%2==1}">style="background-color: pink;"</c:if>  >${item3.newsTitle}</div>
		</c:forEach>
</div>
