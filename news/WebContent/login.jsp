...
function login(){
	...
	if(loginName == ''){
		...
		$.post("loginPage.action",{'user.userName':loginName,'user.password':Password},function(data){
			if(data == '0'){
...
<form action="">
	<table border="0" style="margin-left:200px;margin-top:50px;">
		...
		<tr>
			...
			<td><input id="loginName" type="text"> <span style="color:gray;">没有帐号？</span></td>
		</tr>
		<tr>
		...
		<tr>
			<td></td>
			<td>&nbsp;&nbsp;
				<input type="button" id="login_1" style="height:25px;font:12px" value="登录" onclick="login();">
